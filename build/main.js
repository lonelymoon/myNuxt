...
module.exports = {
  ...
  */
  head: {
    ...
    meta: [{ charset: 'utf-8' }, { name: 'viewport', content: 'width=device-width, initial-scale=1,user-scalable=no' }, { name: 'keywords', content: '游戏,社区,game,策略游戏,手游,手机游戏,ios,安卓,android,PC,moba' }, { hid: 'description', name: 'description', content: 'GameLife,一个简单的游戏社区' }],
    link: [{ rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' }, { rel: 'stylesheet', href: 'https://fonts.cat.net/css?family=Roboto:300,400,500,700|Material+Icons' }]
  },
  /*
  ** Global CSS
  */
  ...
  ** plugins
  */
  plugins: ['~/plugins/vuetify.js', '~/plugins/swiper.js', '~/plugins/echarts.js'],
  /*
  ** transition
  */
  transition: {
